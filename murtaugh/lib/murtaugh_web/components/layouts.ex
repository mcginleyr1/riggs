defmodule MurtaughWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <div class="flex h-screen overflow-hidden" style="background: #060810;">
      <%!-- ── Sidebar ─────────────────────────────────────────────────── --%>
      <aside
        class="w-52 flex-shrink-0 flex flex-col"
        style="background: #07090f; border-right: 1px solid rgba(255,255,255,0.05);"
      >
        <%!-- Wordmark --%>
        <div
          class="px-5 h-14 flex items-center"
        ...
        >
          <div class="flex items-center gap-2.5">
            ...
            <span style="font-family: 'Barlow Condensed', sans-serif; font-weight: 700; font-size: 0.85rem; letter-spacing: 0.18em; text-transform: uppercase; color: rgba(255,255,255,0.85);">
              Murtaugh
            </span>
          </div>
        </div>
        ...
        <div class="mx-3 my-3 px-3 py-2 rounded" style="background: rgba(255,255,255,0.04);">
          <p style="font-family: 'IBM Plex Mono', monospace; font-size: 10px; text-transform: uppercase; letter-spacing: 0.1em; color: rgba(255,255,255,0.3); margin-bottom: 2px;">
            workspace
          </p>
          <p
            style="font-size: 12px; font-weight: 500; color: rgba(255,255,255,0.7);"
            class="capitalize"
          >
            {String.replace(@org_slug, "-", " ")}
          </p>
        </div>
        ...
        <div class="px-4 py-4" style="border-top: 1px solid rgba(255,255,255,0.05);">
          <div class="flex items-center gap-2">
            <span class="relative flex h-1.5 w-1.5">
              ...
              <span class="relative inline-flex rounded-full h-1.5 w-1.5" style="background: #22c55e;">
              </span>
            </span>
            <span style="font-family: 'IBM Plex Mono', monospace; font-size: 10px; color: rgba(255,255,255,0.25); letter-spacing: 0.05em;">
              live
            </span>
          </div>
        </div>
      ...
      <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header
          ...
          style="background: #07090f; border-bottom: 1px solid rgba(255,255,255,0.05);"
        >
          ...
          <div class="flex items-center gap-5">
            <span style="font-family: 'IBM Plex Mono', monospace; font-size: 11px; color: rgba(255,255,255,0.3);">
              ...
              |> then(fn u -> if is_map(u), do: Map.get(u, :email, ""), else: "" end)}
            </span>
            <.link
              href={~p"/logout"}
              method="delete"
